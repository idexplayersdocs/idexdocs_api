...
from src.schemas.caracteristica import (
    CaracteristicaAtacanteCreateSchema,
    CaracteristicaFisicaCreateSchema,
    CaracteristicaGoleiroCreateSchema,
    CaracteristicaLateralCreateSchema,
    CaracteristicaMeiaCreateSchema,
    CaracteristicaVolanteCreateSchema,
    CaracteristicaZagueiroCreateSchema,
)
